...
class msmakeupworkshopTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('msmakeupworkshop')->insert([
        	...
        	'workshop_ownerid' => 7,
        	'workshop_quota' => 10,
            'workshop_categories'=>'wedding;party;pre-wedding',
        ...
        DB::table('msmakeupworkshop')->insert([
        	...
        	'workshop_ownerid' => 4,
        	'workshop_quota' => 20,
            'workshop_categories'=>'wedding;pre-wedding',
        ...
        DB::table('msmakeupworkshop')->insert([
        	...
        	'workshop_ownerid' => 6,
        	'workshop_quota' => 15,
            'workshop_categories'=>'wedding;party',
        ...
        DB::table('msmakeupworkshop')->insert([
        	...
        	'workshop_ownerid' => 4,
        	'workshop_quota' => 5,
            'workshop_categories'=>'pre-wedding',
        ...
        DB::table('msmakeupworkshop')->insert([
        	...
        	'workshop_ownerid' => 3,
        	'workshop_quota' => 8,
            'workshop_categories'=>'party;pre-wedding',
        	'workshop_price' => 140000,
        	'workshop_city' =>'Jakarta Utara',
