...
class msarticlesTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        DB::table('msarticles')->insert([
        	'article_title' => 'Danger that hides in make-up',
        	'article_body' => "They may be reluctant to leave home without it, but make-up is putting women at risk of deadly diseases, say experts.
...
'The situation as it is is plainly dangerous - unacceptably so.'",
				'admin_id' => '2',
				'article_imagecard' => 'article_imagecard1.jpg',
				'article_imagedetail' =>'article_imagedetail1.jpg'
        	]);
...
'The situation as it is is plainly dangerous - unacceptably so.'",
				'admin_id' => '2',
				'article_imagecard' => 'article_imagecard2.jpg',
				'article_imagedetail' =>'article_imagedetail2.jpg'
    	]);
...
'The situation as it is is plainly dangerous - unacceptably so.'",
				'admin_id' => '2',
				'article_imagecard' => 'article_imagecard3.jpg',
				'article_imagedetail' =>'article_imagedetail3.jpg'
		]);
    }
}
